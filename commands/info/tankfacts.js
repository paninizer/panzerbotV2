...
module.exports.run = async (client, message, args) => {
  //the largest and longest embed I've ever written...
  const startingEmbed = {
    color: es.colours.felgrau,
    title: "Tank Facts",
    ...
    fields: [ 
      {
        name: "America",
        value: "As the world's industrial superpower, America has reliable and robust tanks that have great maneuverability and lower-than-average survivability. The later versions changed interactiono jacks-of-all-trades that are decent in everything."
      },
      {
        name: "China",
        value: "China once used imported tanks against the enemies, but it created some of its own designs as well. Lots of its tanks are captured or modified to provide more available parts or tanks. As a result of such, a lot of the tanks are quite different in terms of performance, even if they appear the same. China's own designs feature decent mobility, firepower, and turret armour, but their hull armor and interactionernal modules are rather weak."
      },
      {
        name: "France",
        value: "The French started out their tanks with the best armor, low mobility, and very underwheming guns, but that quickly changed interactiono tanks with great firepower, mobility, but extremely low armour and protection. They have an unique invention that's called drum loader. It differs from Italy's autoloader because it has to load a whole magazine in order to shoot, while Italy only has to load 1 out of a magazine."
      },    
      {
        name: "Germany",
      ...
      {
        name: "USSR",
        value: "This nation has endured lots of terrors, so it's keen to produce many weapons to defend itself and to wage wars. Its tanks are all around decent, with lots of firepower and armour, while mainteractionaining maneuverability and ease of production."
      }      
    ],
    timestamp: new Date(),
  }
    ...
    collector.on('collect', async (interaction) => {
      ...
      if (interaction.isSelectMenu()) {
        ...
        if (interaction.customId==="type_s") {
          await msg.edit({components: [d_btnrow, selectrow]});
          const typeembed = {
            ...
            footer: {
              text: `Use \"${prefix.getPrefix(message.guild.id)||"+"}help\" to view help!`,
            },
            timestamp: new Date(),
          }
            ...
            if (interact.isSelectMenu()) {
              if (interact.customId==="light"||
                ...
                const TankEmbed = {
                  ...
                  color: es.colours.feldgrau
                }
                await message.channel.send({embeds: [TankEmbed]});                
              }
            }
          })
          ...
          await message.channel.send({embeds: [nationEmbed]});
        }
          ...
          await message.channel.send({embeds: [alphaEmbed]});
        }
...
module.exports.name = "tankfacts";
module.exports.description = "Tank facts! Displays facts about tanks, duh.";
module.exports.category = "info";
module.exports.usage = "+tankfacts";
module.exports.aliases = ["tf", "tank"];
